...
<html>
    <div style="background-color:#000000; margin-top: 2em;" >
        <div style="display: grid; grid-template-columns: 30% 70%; margin: 0 auto; width: 95%;">
            <div style="float: left; width: 100%; height: 25em; margin-top: 5em;"  >
                <div style="display:flex;height: 5em; padding: 1em; margin-top: 0.5em;background-color:#d4020d;">
                    <div style="width: 2.5em; display:flex;">
                        <svg fill="#ffffff"x="0px" y="0px" viewBox="0 0 473.806 473.806" style="enable-background:new 0 0 473.806 473.806;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <span class="left-foot">1900 0325 <br>Tư vấn bán hàng</span>
                    
                
                </div>

                <div style="display:flex;height: 5em; align-items: center; padding: 1em; margin-top: 2.2em; margin-bottom: 2.2em;background-color:#d4020d;">
                    <div style="width: 2.5em; display:flex;">
                        <svg fill="#ffffff"x="0px" y="0px" width="356.484px" height="356.484px" viewBox="0 0 356.484 356.484" style="enable-background:new 0 0 356.484 356.484;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <span class="left-foot">0794205472<br>Hỗ trợ dịch vụ</span>
                    
                
                </div>

                <div style="display:flex;height: 5em; align-items: center; padding: 1em; margin-top: 0.5em;background-color:#d4020d;">
                    <div style="width: 2.5em; display:flex;">
                        <svg fill="#ffffff" x="0px" y="0px" viewBox="0 0 54 54" style="enable-background:new 0 0 54 54;" xml:space="preserve">
                            <g>
                    ...
                    <span class="left-foot">0247 306 3555<br>Tư Vấn Kĩ thuật</span>
                </div>       
            </div>


            <div style= "margin-top: 5em; width: 95%">
                <div style="display: grid; grid-template-columns: 30% 30% 40%; width: 100%;">
                    <div>
                        <ul class="footer-columns">CHĂM SÓC KHÁCH HÀNG
                            <li class="footer-rows">Hướng dẫn mua hàng</li>
                            <li class="footer-rows">Chính sách đổi trả</li>
                            <li class="footer-rows">Chính sách bảo hành</li>
                            <li class="footer-rows">Tra cứu bảo hành</li>
                            
                        </ul>
                    </div>
                    <div>
                        <ul class="footer-columns">VỀ KQWATCH
                            <li class="footer-rows">Giới thiệu về KQwatch</li>
                            <li class="footer-rows">Triết lí kinh doanh</li>
                            <li class="footer-rows">Giấy chứng nhận và giải thưởng</li>
                            <li class="footer-rows">Khách hàng nói gì về chúng tôi</li>
                            
                        </ul>
                    </div>

                    <div>
                        <ul class="footer-columns">TIỆN ÍCH
                            <li class="footer-rows">Kiến thức đồng hồ</li>
                            <li class="footer-rows">Thông tin liên hệ</li>
                            <li class="footer-rows">Tuyển dụng</li>
                            
                        </ul>
                    </div>
                </div>

                <div style="display: flex; height: 6em; margin: 0 auto;">

                    <div style="margin-left: 2em; margin-top: 1em ">
                        <img src="/logo_tham_dinh.png" alt="">
                    </div>
                    ...
                    <div style="width: 6em; "class="last-footer">
                        <svg fill="#fff" x="0px" y="0px" viewBox="0 0 112.196 112.196" style="enable-background:new 0 0 112.196 112.196;" xml:space="preserve">
                            <g>
                    ...
                    <div style="width: 6em; " class="last-footer">
                        <svg x="0px" y="0px" viewBox="0 0 473.931 473.931" style="enable-background:new 0 0 473.931 473.931;" xml:space="preserve">
